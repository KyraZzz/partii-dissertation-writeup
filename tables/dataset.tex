...
\adjustbox{max width=\hsize}{
	...
	\multirow{3}{*}{SST2} 
        & \multirow{3}{*}{2}
        & A binary sentiment analysis task on movie reviews from the Stanford Sentiment Treebank \cite{Wang18glue}. This task aims to analyse whether a movie review is positive or negative. \\
